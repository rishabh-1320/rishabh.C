...
import { Section, Container, Text, Eyebrow, Card, Row, IconBadge } from "@packages/ds-ui";

export function DsAiWorkflow({ aiWorkflow }: { aiWorkflow: HomeContent["aiWorkflow"] }) {
  return (
    <Section bg="ink" pad="lg" id="ai">
      <Container>
        <div className="grid gap-12 md:grid-cols-[1fr_1.1fr] md:gap-16">
          <div className="flex flex-col gap-5">
            ...
            <Card surface="outline" pad="md" radius="rounded-ds-lg" className="mt-2">
