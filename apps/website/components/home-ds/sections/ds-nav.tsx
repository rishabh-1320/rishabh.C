          ...
          <div className="flex flex-col">
            {LINKS.map((l) => (
              <a
                ...
                className="border-t border-ds-border py-3 first:border-t-0"
              >
            ...
            <a
              ...
              rel="noopener noreferrer"
              onClick={() => setOpen(false)}
              className="mt-3 rounded-ds-pill bg-ds-accent px-4 py-3 text-center font-ds-sans text-ds-body-sm font-semibold text-ds-on-ink"
            >
              Download Resume
            </a>
          </div>
