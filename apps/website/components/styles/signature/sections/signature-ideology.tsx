...
import { Section, Container, Text, Eyebrow, Card } from "../ui";

export function SignatureIdeology({
  heading,
  principles
}: {
  heading: string;
    ...
    <Section bg="page" pad="lg" id="ideology">
      <Container>
        <div className="mb-12 flex flex-col gap-3">
          ...
          <Text variant="h2" className="max-w-prose">
            {heading}
          </Text>
        </div>
        ...
        <div className="grid gap-5 md:grid-cols-2">
          {principles.map((p, i) => (
            ...
            >
              <Text variant="display" as="span" className="text-accent">
                {p.id}
              </Text>
